Shader "Hidden/HolisticMotionCapture/PoseVisualizer"
{
    CGINCLUDE
    ...
    v2f VertexLine(uint vid : SV_VertexID, uint iid : SV_InstanceID)
    {
        ...
        o.color = (score >= _poseThreshold) ? float4(0, 1, 0, 1) : float4(0, 0, 1, 0);
        return o;
    }
    ...
    {   
        ...
        // Color alpha is defined by landmark visibility.
        o.color = (score >= _poseThreshold) ? float4(1, 0, 0, 1) : float4(0, 0, 1, 0);
        return o;
    }
